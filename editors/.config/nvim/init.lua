...
-- Configure :cnext and :cprev with Ctrl-j and Ctrl-k, respectively
vim.keymap.set('n', '<C-j>', function() vim.cmd.cnext() end, { silent = true })
vim.keymap.set('n', '<C-k>', function() vim.cmd.cprev() end, { silent = true })
...
require('lazy').setup({
  ...
  --   opts = {
  --     default_scheme = 'base24-tomorrow-night', -- pick any bundled Base16/Base24
